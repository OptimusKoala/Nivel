...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-156%20core%20%2B%2086%20app-3a1220?style=flat-square" alt="156 tests NivelCore + 86 tests app"/>
...
│  messages · planner widget  │  156 tests, `swift test` en 0,04 s.
└─────────────┬───────────────┘
              │
    ┌─────────┴─────────┐
┌───▼──────────┐  ┌─────▼─────────┐
